                               ...
                               <tbody>
                                ...
                                <tr id="htr{{$valor->idperfil}}">
                                     ...
                                     <td class="center" style="width: 9rem">
                                       <a href="#updHotspot" id="updHotspot{{$valor->idperfil}}" class="tooltipped modal-trigger" data-position="top" data-delay="500" data-tooltip="Ver" data-id="{{$valor->idperfil}}" data-idrouter="{{$valor->idrouter}}" data-name="{{$valor->name}}" data-vbajada="{{$valor->vbajada}}" data-precio="{{$valor->precio}}" data-vsubida="{{$valor->vsubida}}" data-glosa="{{$valor->glosa}}" data-idrouter="{{$valor->idrouter}}" data-estado="{{$valor->estado}}" data-dsc_perfil="{{$valor->dsc_perfil}}" data-perfil="{{$valor->hotspot_perfil}}" data-users="{{$valor->shared_users}}" data-tiempo="{{$valor->sesion_time}}" data-nalternativo="{{$valor->nalternativo}}">
                                        <i class="material-icons" style="color: #7986cb ">visibility</i></a>                                       
                                       <a href="#h_confirmacion{{$valor->idperfil}}" class="tooltipped modal-trigger" data-position="top" data-delay="500" data-tooltip="Eliminar">
                                        <i class="material-icons" style="color: #dd2c00">remove</i></a> 
                                       @if($valor->estado == 1)                                      
                                       <a href="#h_confirmacion2{{$valor->idperfil}}" class="tooltipped modal-trigger" data-position="top" data-delay="500" data-tooltip="Desabilitar">
                                        <i class="material-icons" style="color: #757575 ">clear</i></a>
                                       @else
                                       <a href="#h_confirmacion3{{$valor->idperfil}}" class="tooltipped modal-trigger" data-position="top" data-delay="500" data-tooltip="Habilitar">
