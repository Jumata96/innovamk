         ...
         <tr v-for="doc_venta in doc_ventas">
          ...
          <td v-else>  
           ...
           <td v-text="doc_venta.fecha_creacion"></td>
            <td v-if="doc_venta.estado == 1"><div id="estado2" class="badge green lighten-5 green-text text-accent-4 center">
              <b>ACTIVO</b>
              <i class="material-icons"></i>
            </div></td>
            <td v-if="doc_venta.estado == 2"><div id="estado" class="badge grey darken-2 white-text text-accent-5 center">
              <b>INACTIVO</b>
              <i class="material-icons"></i>
            </div></td> 
           <td>
             <a class="tooltipped" data-position="top" data-delay="500" title="Editar" v-on:click.prevent="edit(doc_venta)">
             <i class="material-icons" style="color: #7986cb">visibility</i>
             </a>
             <a class="tooltipped" data-position="top" data-delay="500" title="Eliminar" v-on:click.prevent="deleteDocVenta(doc_venta)">
             <i class="material-icons" style="color: #dd2c00">remove</i>
             </a>
             <a v-if="doc_venta.estado == 2" class="tooltipped" data-position="top" data-delay="500" title="Habilitar" v-on:click.prevent="enableDocVenta(doc_venta)">
             <i class="material-icons" style="color: #2e7d32">check</i>
             </a>
             <a v-else class="tooltipped" data-position="top" data-delay="500" title="Dehabilitar" v-on:click.prevent="disableDocVenta(doc_venta)">
             <i class="material-icons" style="color: #757575">clear</i>
             </a>            
           </td>
         </tr>
